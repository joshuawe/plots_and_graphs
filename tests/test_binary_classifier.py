...
def test_hist_plot(random_data_binary_classifier):
    ...
    binary.plot_y_prob_histogram(
        y_prob, save_fig_path=TEST_RESULTS_PATH / "histogram.png"
    )
    binary.plot_y_prob_histogram(
        y_prob, y_true, save_fig_path=TEST_RESULTS_PATH / "histogram_2_classes.png"
    )
    return
...
def test_pr_curve(random_data_binary_classifier):
    ...
    binary.plot_pr_curve(
        y_true, y_prob, save_fig_path=TEST_RESULTS_PATH / "pr_curve.png"
    )
    return
...
def test_confusion_matrix(random_data_binary_classifier):
    ...
    binary.plot_confusion_matrix(
        y_true, y_prob, save_fig_path=TEST_RESULTS_PATH / "confusion_matrix.png"
    )
    return
...
def test_classification_report(random_data_binary_classifier):
    ...
    binary.plot_classification_report(
        y_true, y_prob, save_fig_path=TEST_RESULTS_PATH / "classification_report.png"
    )
    return
...
def test_accuracy(random_data_binary_classifier):
    ...
    binary.plot_accuracy(
        y_true, y_prob, save_fig_path=TEST_RESULTS_PATH / "accuracy.png"
    )
    return